          ...
          <div className="rounded overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                target.outerHTML = `
                  <div class="w-full h-32 bg-slate-100 dark:bg-slate-800 rounded flex items-center justify-center text-slate-400 dark:text-slate-600 flex-col p-4 text-center">
